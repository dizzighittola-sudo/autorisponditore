...
function setupProductionTrigger() {
  ...
  // Crea trigger ogni 10 minuti (raccomandato)
...
- Aumentare intervallo trigger (es. ogni 15 min invece di 10)
...
4. **Contatta** support@exnovobots.com con:
   - Descrizione problema
   - Log relevanti
   - Configurazione (mascherata)

**Canali supporto:**
- 📧 Email: support@exnovobots.com (risposta entro 24h)
